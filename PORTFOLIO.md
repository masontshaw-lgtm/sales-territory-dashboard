...
6. **Explain verification:** eight tests cover sample totals, follow-up behavior, empty results, CSV handling, interface filters, and filtered CSV downloads. Tests are repeatable checks, not a guarantee against every possible bug.
